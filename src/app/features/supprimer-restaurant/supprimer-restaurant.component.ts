...
export class SupprimerRestaurantComponent implements OnInit {
  ...
  restaurants: Restaurant[] = [
    ...
    {'nom': 'La cantine du coin', 'adresse': '22 rue d\'Angular', 'dateDerniereVisite': '12/02/2019', 'note': null, 'nombreVisite': 1, 'nombreCommentaire': 2, 'commentaire': [{'auteur': 'Olga', 'texte': 'Pas mal, même si ça manque de kimchi.'}, {'auteur': 'Romain', 'texte': 'Permet de faire une coupure entre 2 UST back.'}], 'restaurantId': 0},
    // tslint:disable-next-line:max-line-length
    ...
    // tslint:disable-next-line:max-line-length
    {'nom': 'L\'indigestion fatale', 'adresse': '33 rue du Dr Petiot', 'dateDerniereVisite': '14/01/2019', 'note': null, 'nombreVisite': 1, 'nombreCommentaire': 1, 'commentaire': [{'auteur': 'Nicolas', 'texte': 'N\'y allez pas, c\'est ... arrrrrrrrrrg !'}], 'restaurantId': 7},
    // tslint:disable-next-line:max-line-length
    ...
    // tslint:disable-next-line:max-line-length
    {'nom': 'Le chinois traditionnel', 'adresse': '32 rue de 中华人民共和国', 'dateDerniereVisite': '14/02/2019', 'note': 2, 'nombreVisite': 1, 'nombreCommentaire': 1, 'commentaire': [{'auteur': 'Nicolas', 'texte': 'Cette escalope de chat n\'était pas si mauvaise.'}], 'restaurantId': 11},
    // tslint:disable-next-line:max-line-length
    {'nom': 'La citrouille de Cendrillon', 'adresse': '54 rue de la princesse', 'dateDerniereVisite': '13/02/2019', 'note': 3, 'nombreVisite': 1, 'nombreCommentaire': 2, 'commentaire': [{'auteur': 'Antoine', 'texte': 'Impossible de rester manger après minuit.'}, {'auteur': 'Olga', 'texte': 'J\'ai perdu une chaussure en sortant de ce restaurant.'}], 'restaurantId': 12},
    // tslint:disable-next-line:max-line-length
    {'nom': 'Chez Jean Bombeur', 'adresse': '26 rue du sandwich', 'dateDerniereVisite': '31/01/2019', 'note': null, 'nombreVisite': 2, 'nombreCommentaire': 3, 'commentaire': [{'auteur': 'Romain', 'texte': 'Le panini sprint boot est sympa.'}, {'auteur': 'Marie', 'texte': 'Parfait pour un déjeuner rapide entre 10 réunions.'}, {'auteur': 'Gilles', 'texte': 'Le sandwich purée/pâtes est un peu bourratif.'}], 'restaurantId': 13},
    // tslint:disable-next-line:max-line-length
    {'nom': 'Star Wars fast food', 'adresse': '7 rue de la Force', 'dateDerniereVisite': '18/01/2019', 'note': 3, 'nombreVisite': 1, 'nombreCommentaire': 0, 'commentaire': [], 'restaurantId': 14},
    // tslint:disable-next-line:max-line-length
    {'nom': 'Le petit patapon', 'adresse': '47 allée du éronéron', 'dateDerniereVisite': '07/01/2019', 'note': 4, 'nombreVisite': 1, 'nombreCommentaire': 2, 'commentaire': [{'auteur': 'Johan', 'texte': 'Il était une bergère 🎵 ...'}, {'auteur': 'Romain', 'texte': 'Ambiance bon enfant.'}], 'restaurantId': 15},
    // tslint:disable-next-line:max-line-length
    ...
    // tslint:disable-next-line:max-line-length
    {'nom': 'La licorne enchantée', 'adresse': '101 rue de la drogue', 'dateDerniereVisite': '15/02/2019', 'note': 4, 'nombreVisite': 2, 'nombreCommentaire': 2, 'commentaire': [{'auteur': 'Nicolas', 'texte': 'C\'est trop bien : je suis fan.'}, {'auteur': 'Johan', 'texte': 'Il faut entrer un code secret pour acceder au menu !'}], 'restaurantId': 20},
    // tslint:disable-next-line:max-line-length
